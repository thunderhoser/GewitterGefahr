...
THESE_TEMPERATURES_DEG_C[2] = SENTINEL_VALUE
THESE_DEWPOINTS_DEG_C[2] = SENTINEL_VALUE
THESE_U_WINDS_KT[2] = SENTINEL_VALUE
...
# The following constants are used to test _remove_subsurface_sounding_data.
THESE_PRESSURES_MB = THESE_PRESSURES_MB[1:]
THESE_HEIGHTS_M_ASL = THESE_HEIGHTS_M_ASL[1:]
THESE_TEMPERATURES_DEG_C = THESE_TEMPERATURES_DEG_C[1:]
THESE_DEWPOINTS_DEG_C = THESE_DEWPOINTS_DEG_C[1:]
THESE_U_WINDS_KT = THESE_U_WINDS_KT[1:]
THESE_V_WINDS_KT = THESE_V_WINDS_KT[1:]
