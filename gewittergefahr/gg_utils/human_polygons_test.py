...
THIS_FIRST_OBJECT = polygons.vertex_arrays_to_polygon_object(
    exterior_x_coords=FIRST_GRID_COLUMN_BY_VERTEX,
    exterior_y_coords=FIRST_GRID_ROW_BY_VERTEX)
...
THIS_FIFTH_OBJECT = polygons.vertex_arrays_to_polygon_object(
    exterior_x_coords=FIFTH_GRID_COLUMN_BY_VERTEX,
    exterior_y_coords=FIFTH_GRID_ROW_BY_VERTEX)
