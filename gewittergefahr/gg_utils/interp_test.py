...
QUERY_TIMES_UNIX_SEC = numpy.array([1, 2, 3])
...
EXPECTED_QUERY_MATRIX_TIME3 = numpy.array([[1.5, 4.25, 6.5, 13.75],
                                           [-0.5, 1.75, 4.5, 7.5],
                                           [-2., -2.5, 0.75, 5.]])
EXPECTED_QUERY_MATRIX_FOR_TEMPORAL_INTERP = (
    numpy.stack((EXPECTED_QUERY_MATRIX_TIME1, EXPECTED_QUERY_MATRIX_TIME2,
...
class InterpTests(unittest.TestCase):
    ...
    def test_interp_in_time(self):
        ...
        self.assertTrue(numpy.allclose(
            this_query_matrix, EXPECTED_QUERY_MATRIX_FOR_TEMPORAL_INTERP,
            atol=TOLERANCE))
