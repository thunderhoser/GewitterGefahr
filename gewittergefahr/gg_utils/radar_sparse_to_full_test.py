...
RADAR_VALUES = numpy.array([35, 50, 70, 65], dtype=float)
...
SPARSE_GRID_DICT = {
    myrorss_and_mrms_io.GRID_ROW_COLUMN: START_ROWS,
    myrorss_and_mrms_io.GRID_COLUMN_COLUMN: START_COLUMNS,
    myrorss_and_mrms_io.NUM_GRID_CELL_COLUMN: GRID_CELL_COUNTS,
...
class RadarSparseToFullTests(unittest.TestCase):
    ...
    def test_convert_no_values_ignored(self):
        ...
        this_full_matrix = radar_s2f._convert(
            sparse_grid_table=SPARSE_GRID_TABLE, field_name=RADAR_FIELD_NAME,
