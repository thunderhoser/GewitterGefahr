...
THESE_COLUMN_INDICES = numpy.linspace(-96, -1, num=64, dtype=float)
...
THESE_ROW_INDICES = numpy.linspace(1, 40, num=49, dtype=float)
THESE_COLUMN_INDICES = numpy.linspace(51, 83, num=33, dtype=float)
THESE_HEIGHT_INDICES = numpy.linspace(101, 113, num=13, dtype=float)
THIS_COLUMN_INDEX_MATRIX, THIS_ROW_INDEX_MATRIX, THIS_HEIGHT_INDEX_MATRIX = (
    numpy.meshgrid(
        THESE_COLUMN_INDICES, THESE_ROW_INDICES, THESE_HEIGHT_INDICES
    )
)
