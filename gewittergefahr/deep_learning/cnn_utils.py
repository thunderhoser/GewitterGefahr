...
def _check_input_args_for_conv_layer(
        ...
        num_rows_per_stride, num_columns_per_stride, activation_function,
        is_first_layer, num_kernel_depths=None, num_depths_per_stride=None,
        num_input_rows=None, num_input_columns=None, num_input_channels=None,
...
def get_3d_conv_layer(
        ...
        num_depths_per_stride, kernel_weight_init='glorot_uniform',
        bias_weight_init='zeros', activation_function='relu',
