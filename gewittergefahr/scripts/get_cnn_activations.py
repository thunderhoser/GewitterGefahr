...
def _read_input_one_spc_date(
    ...
    if model_metadata_dict[cnn.USE_2D3D_CONVOLUTION_KEY]:
        ...
        this_list_of_input_matrices = [
            this_example_dict[deployment_io.REFLECTIVITY_MATRIX_KEY],
            this_example_dict[deployment_io.AZ_SHEAR_MATRIX_KEY]
        ]
        ...
        this_list_of_input_matrices = [
            this_example_dict[deployment_io.RADAR_IMAGE_MATRIX_KEY]
        ]
