"""Trains convolutional neural net with 3-D GridRad images."""
...
NUM_RADAR_FILTERS_ARG_NAME = 'first_num_radar_filters'
REFL_MASK_ARG_NAME = 'refl_masking_threshold_dbz'
...
REFL_MASK_HELP_STRING = (
    ...
    'reflectivity < `{0:s}` will be masked out, using '
    '`deep_learning_utils.mask_low_reflectivity_pixels`.'
).format(REFL_MASK_ARG_NAME)
...
def _run(output_model_dir_name, num_epochs, num_training_batches_per_epoch,
         ...
         num_examples_per_batch, radar_field_names, sounding_field_names,
         num_grid_rows, num_grid_columns, normalization_type_string,
         ...
         max_noise_standard_deviation, num_radar_conv_layer_sets,
         ...
         first_num_radar_filters, refl_masking_threshold_dbz):
    """Trains convolutional neural net with 3-D GridRad images.
    ...
    :param first_num_radar_filters: See documentation at top of this file.
...
if __name__ == '__main__':
    ...
    _run(
        ...
        radar_field_names=getattr(
            INPUT_ARG_OBJECT, dl_helper.RADAR_FIELDS_ARG_NAME),
        ...
        first_num_radar_filters=getattr(
            INPUT_ARG_OBJECT, NUM_RADAR_FILTERS_ARG_NAME),
        refl_masking_threshold_dbz=getattr(INPUT_ARG_OBJECT, REFL_MASK_ARG_NAME)
    )
