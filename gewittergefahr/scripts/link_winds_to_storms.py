...
SPC_DATE_HELP_STRING = (
    ...
    'on this date will be linked to zero or more wind observations.')
WIND_DIR_HELP_STRING = (
    'Name of top-level directory with wind observations (files readable by'
...
LINKAGE_DIR_HELP_STRING = (
    ...
    ' `link_events_to_storms.write_storm_to_winds_table`).  One file will be '
    'created here, for the whole SPC date.')
...
def _link_winds_to_storms(
        spc_date_string, top_wind_dir_name, top_tracking_dir_name,
    ...
    events2storms.write_storm_to_winds_table(
...
if __name__ == '__main__':
    ...
    _link_winds_to_storms(
        spc_date_string=SPC_DATE_STRING, top_wind_dir_name=TOP_WIND_DIR_NAME,
