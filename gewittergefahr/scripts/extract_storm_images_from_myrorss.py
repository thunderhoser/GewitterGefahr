...
def _extract_storm_images(
        num_image_rows, num_image_columns, spc_date_string,
        tarred_myrorss_dir_name, untarred_myrorss_dir_name, tracking_dir_name,
    ...
    myrorss_io.unzip_1day_tar_file(
        ...
        field_names=AZIMUTHAL_SHEAR_FIELD_NAMES, spc_date_string=spc_date_string,
        top_target_directory_name=untarred_myrorss_dir_name)
    print SEPARATOR_STRING

    # Untar files with other radar fields.
    non_shear_field_names = list(
        set(storm_images.DEFAULT_MYRORSS_MRMS_FIELD_NAMES) -
        set(AZIMUTHAL_SHEAR_FIELD_NAMES))
    ...
    myrorss_io.remove_unzipped_data_1day(
        ...
        field_names=storm_images.DEFAULT_MYRORSS_MRMS_FIELD_NAMES)
    print SEPARATOR_STRING
