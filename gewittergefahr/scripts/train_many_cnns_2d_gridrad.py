"""Trains many convolutional neural nets (CNN) with 2-D GridRad images.

Native GridRad images are 3-D.  2-D images are created by "reducing" the 3-D
images via layer operations.
"""
...
RADAR_FIELDS_KEY = 'radar_field_name_by_channel'
LAYER_OPERATIONS_KEY = 'layer_op_name_by_channel'
MIN_HEIGHTS_KEY = 'min_height_by_channel_m_agl'
MAX_HEIGHTS_KEY = 'max_height_by_channel_m_agl'
...
ARGUMENT_FILES_HELP_STRING = (
    ...
    'arguments for the single-CNN script train_cnn_gridrad_2d_reduced.py.  Each'
    ' file should be a Pickle file, containing only said dictionary.')
...
def _train_one_cnn(gpu_queue, argument_dict):
    ...
    try:
        ...
        cnn.train_cnn_gridrad_2d_reduced(
            ...
            metadata_dict[cnn.LAYER_OPERATIONS_KEY],
