...
SPC_DATE_HELP_STRING = (
    ...
    'will be computed independently for each date from `{0:s}`...`{1:s}`.  In '
    'other words, each date will be one job.').format(
...
def _write_slurm_file(
    ...
    # Compute sounding stats for the given SPC date.
    slurm_file_handle.write(
...
if __name__ == '__main__':
    ...
    _write_slurm_file(
        ...
        slurm_file_name=SLURM_FILE_NAME, lead_times_seconds=LEAD_TIMES_SECONDS,
