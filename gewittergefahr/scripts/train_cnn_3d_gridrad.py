...
def _run(input_model_file_name, radar_field_names, sounding_field_names,
         ...
         refl_masking_threshold_dbz, num_translations, max_translation_pixels,
         num_rotations, max_rotation_angle_deg, num_noisings,
         max_noise_standard_deviation, top_training_dir_name,
...
if __name__ == '__main__':
    ...
    _run(
        ...
        downsampling_fractions=numpy.array(
            getattr(INPUT_ARG_OBJECT, dl_helper.DOWNSAMPLING_FRACTIONS_ARG_NAME),
            dtype=float),
